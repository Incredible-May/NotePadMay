...
public class NotesList extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button=(Button)findViewById(R.id.btn_listchangebackground);
        appbackground = getSharedPreferences("noteapp", MODE_PRIVATE);
        NoteAttribute.snoteBackground=appbackground.getInt(NoteAttribute.NOTEBACKGROUND,0);
       ...
       // setBackgroundMenu();
        ...
        String[] dataColumns = { NotePad.Notes.COLUMN_NAME_TITLE ,NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE } ;//myjia

        // The view IDs that will display the cursor columns, initialized to the TextView in
        // noteslist_item.xml
        int[] viewIDs = { R.id.tv_showtitle,R.id.tv_showdate};

        // Creates the backing adapter for the ListView.
        adapter = new SimpleCursorAdapter(
                      this,                             // The Context for the ListView
                      R.layout.mynotelist_item,  //设置listview中item布局        // Points to the XML for a list item
     ...
     */
    @Override
    public boolean onCreateOptionsMenu(Menu menu) {//标题栏上的
    ...
    public void onCreateContextMenu(ContextMenu menu, View view, ContextMenuInfo menuInfo) {
         ...
         */
        Cursor cursor = (Cursor) getListAdapter().getItem(info.position-1);//出现bug,长按最后一个崩溃，故减1
